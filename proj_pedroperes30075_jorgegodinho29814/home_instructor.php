    ...
    <body>
        ...
        <div class="col-sm-4">
            ...
            <div class="list-group">
                <a class="list-group-item" href="ver_horario.php">Ver Horario</a>
                <a class="list-group-item" href="lista_presencas_por_unidade_curricular_determinado_horario.php">Lista de presencas por unidade curricular num determinado horario</a>
                <a class="list-group-item" href="lancar_notas.php">Lancar Notas</a>
                <a class="list-group-item" href="pesquisar_salas_livres.php">Pesquisar salas livres</a>
                <a class="list-group-item" href="atualizar_dados.php">Atualizar dados</a>
            </div>
        </div>
